  ...
  var t,
    ...
    T = function (i, n) {
      t.ev.triggerHandler(g + i, n),
        t.st.callbacks &&
          ((i = i.charAt(0).toLowerCase() + i.slice(1)), t.st.callbacks[i] && t.st.callbacks[i].apply(t, e.isArray(n) ? n : [n]));
    },
    E = function () {
    ...
    S = function (i) {
      return (
        (i === s && t.currTemplate.closeBtn) || ((t.currTemplate.closeBtn = e(t.st.closeMarkup.replace("%title%", t.st.tClose))), (s = i)),
          ...
          if (((o = e.split("_")), o.length > 1)) {
            ...
            if (n.length > 0) {
              ...
              "replaceWith" === a
                ...
                ? n.is("img")
                  ? n.attr("src", i)
                  : n.replaceWith('<img src="' + i + '" class="' + n.attr("class") + '" />')
                : n.attr(o[1], i);
            }
      ...
      getInline: function (i, n) {
        if ((L(), i.src)) {
          ...
          if (a.length) {
            ...
            r && r.tagName && (M || ((z = o.hiddenClass), (M = k(z)), (z = "mfp-" + z)), (B = a.after(M).detach().removeClass(z))),
            ...
            N && clearInterval(N),
              (N = setInterval(function () {
                return n.naturalWidth > 0
                  ...
                  : (i > 200 && clearInterval(N), i++, 3 === i ? o(10) : 40 === i ? o(50) : 100 === i && o(500), void 0);
              }, a));
          };
        o(1);
      },
      getImage: function (i, n) {
        var o = 0,
          ...
          r = function () {
            i &&
              (i.img.off(".mfploader"),
              i === t.currItem && (t._onImageHasSize(i), t.updateStatus("error", s.tError.replace("%url%", i.src))),
              (i.hasSize = !0),
              (i.loaded = !0),
              (i.loadError = !0));
          },
        ...
        return (
          ...
          i.hasSize
            ? (N && clearInterval(N),
              i.loadError
                ? (n.addClass("mfp-loading"), t.updateStatus("error", s.tError.replace("%url%", i.src)))
  ...
  e.magnificPopup.registerModule("zoom", {
    ...
    proto: {
      ...
      _getOffset: function (i) {
        ...
        return (
          Z() ? (s["-moz-transform"] = s.transform = "translate(" + o.left + "px," + o.top + "px)") : ((s.left = o.left), (s.top = o.top)),
          s
        );
      },
    },
      ...
      getIframe: function (i, n) {
        ...
        e.each(a.patterns, function () {
          return o.indexOf(this.index) > -1
            ? (this.id &&
                (o = "string" == typeof this.id ? o.substr(o.lastIndexOf(this.id) + this.id.length, o.length) : this.id.call(this, o)),
              ...
              (u = !1),
                ...
                I.on("touchmove" + a, function (e) {
                  (p = e.originalEvent ? e.originalEvent.touches : e.touches),
                    (f = p.length),
                    (p = p[0]),
                    (Math.abs(p.clientX - c) > 10 || Math.abs(p.clientY - d) > 10) && ((u = !0), n());
