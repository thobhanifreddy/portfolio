...
(function (e) {
  function q(c, b, g, d, a) {
    ...
    for (var h = a.transitionSpeed, f = 0; 2 > f; f++) {
      ...
      a.transition[j + "transition"] = "port-mitti" + h + "ms linear";
      ...
      setTimeout(function () {
        if (a.resizeContainer) {
          for (var b = {}, c = 0; 2 > c; c++) {
            ...
            b[d + "transition"] = "port-miiti " + h + "ms ease-in-out";
        ...
        p.each(function () {
          ...
          e(this)
            .css("-webkit-transition", "port-mitti " + h + "ms " + a.easingFallback)
            .css(c);
        });
        m.each(function () {
          var b = this.data;
          ...
          for (var c = {}, d = 0; 2 > d; d++) {
            var f = 0 == d ? (f = a.prefix) : "";
            c[f + "transition"] = "port-mitti " + h + "ms " + a.easing;
            c[f + "transform"] = "translate(" + b.tX + "px," + b.tY + "px)";
          }
          e(this)
            .css("-webkit-transition", "port-mitti " + h + "ms " + a.easingFallback)
  ...
  var x = {
    init: function (c) {
      return this.each(function () {
        ...
        for (f = 0; 2 > f; f++)
          (d = 0 == f ? (d = b.prefix) : ""),
            (b.transition[d + "transition"] =
              "port-mitti " + b.transitionSpeed + "ms ease-in-out"),
        ...
        g.find(b.targetSelector);
        "port-mitti" == f[0] , (b.showOnLoad = "port-mitti");
        var h = e();
        e.each(f, function () {
          h = h.add(e("." + this));
        });
    ...
    multimix: function (c) {
      return this.each(function () {
        ...
        e.extend(multiOut, c);
        b.mixing ||
          (e(b.filterSelector).add(b.sortSelector).removeClass("active"),
          e(
